...
def loop(a, b, one):
  ...
  EXPECT_EQ(
      after_forced.forced_deopt_hits, before.forced_deopt_hits + 1);
  EXPECT_EQ(
      after_forced.organic_deopt_hits, before.organic_deopt_hits);
  ...
  EXPECT_EQ(
      after_organic.forced_deopt_hits, after_forced.forced_deopt_hits);
  EXPECT_GT(
      after_organic.organic_deopt_hits, after_forced.organic_deopt_hits);
}
