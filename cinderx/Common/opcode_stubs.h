...
#if PY_VERSION_HEX >= 0x030e0000
#define BINARY_OP_SUBSCR_LIST_INT BINARY_SUBSCR_LIST_INT
#define BINARY_OP_SUBSCR_TUPLE_INT BINARY_SUBSCR_TUPLE_INT
#define BINARY_OP_SUBSCR_DICT BINARY_SUBSCR_DICT
#endif
