...
// We are effectively importing two pycore_opcode's here. First we import the
// one generated with CinderX opcodes but with the names re-defined to the _Ci
// prefixes. Then we import the normal CPython one to get the original names as
// external references.
